...
const LoginForm = ({ onLogin }) => {
    ...
    return (
        <main  className="bg-color-main dark:bg-color-main-dark dark:text-color-bright-dark h-screen>
            ...
            <div className="bg-color-main dark:bg-color-main-dark dark:text-color-bright-dark h-full">
