            ...
            <Drawer
                ...
                <div className="flex flex-col justify-evenly bg-color-contrast dark:bg-color-contrast-dark h-screen">
                    ...
                    <div className='flex content-center items-center mx-20'>
                        ...
                        <h6 className='text-slate-900 text-2xl mx-3'><Link to="/">My Jobs</Link></h6></div>
                    <div className='flex content-center items-center mx-20'>
                        <AiFillDashboard className="mx-3 text-3xl text-slate-900 " />
                        <h6 className='text-slate-900 text-2xl mx-3'><Link to="/dashboard">Dashboard</Link></h6></div>
                    <div className='flex content-center items-center  mx-20'>
                        <FaSearch className="mx-3 text-3xl text-slate-900 " />
                        <h6 className='text-slate-900 text-2xl m-2'><Link to="/jobsearch">Job Search</Link></h6></div>
                    <div className='flex content-center items-center  mx-20'>
                        <BsFillChatDotsFill className="mx-3 text-3xl text-slate-900 " />
                        <h6 className='text-slate-900 text-2xl m-2'><Link to="/chatboard">Chat Board</Link></h6></div>
                    <div className='flex content-center items-center  mx-20'>
                    ...
                    <div className="flex flex-row items-center bg-color-highlight dark:bg-color-highlight-dark  justify-center p-2 mx-auto w-1/3 rounded">
                        ...
                        <button className="flex flex-col justify-center bg-color-highlight dark:bg-color-highlight-dark rounded mx-auto my-2 flex flex-col items-center w-5/6 shadow-3xl" onClick={() => logout()}>Logout
                        </button>
                    </div>
                </div>
            </Drawer>
