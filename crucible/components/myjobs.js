            ...
            <div data-testid="myjobs-1">
                ...
                <main className="dark:bg-color-main-dark dark:text-color-bright-dark h-screen ">
                    <div className="flex flex-col items-center content-center w-full" >
                        <button id="addjobsbtn" className="flex items-center content-center text-2xl justify-center m-5 rounded shadow-xl bg-color-highlight dark:bg-color-highlight-dark dark:text-neutral-900 py-5 w-4/5" onClick={() => {
                            setIsModalOpen(true)
